 ...
 * Finally for a A x B matrix, the transmission cost will be O(B * A * num_processes)
 */
 ...
 * @note The whole vector is passed directly to the token ring. If size(multiply_vector) = N, the transmission cost will be O(N * num_processes)
 */
